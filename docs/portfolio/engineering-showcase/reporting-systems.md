...
- ![Customer Support Dashboard](../../assets/images/engineering-showcase/qa-dashboard/customer-support-dashboard.png)
...
- ![Master Test Repository](../../assets/images/engineering-showcase/qa-dashboard/master-test-repository.png)

    **Master Test Repository**

    Centralized repository for test execution, planning, and release readiness.

- ![Defect Management Dashboard](../../assets/images/engineering-showcase/qa-dashboard/defect-management-dashboard.png)

    **Defect Management**

    Tracks defect trends, severity distribution, and software quality metrics.

- ![Automation Coverage Dashboard](../../assets/images/engineering-showcase/qa-dashboard/automation-coverage-dashboard.png)
...
![Security Dashboard](../../assets/images/engineering-showcase/qa-dashboard/security-dashboard.png){ loading=lazy }
...
![Master Test Repository](../../assets/images/engineering-showcase/qa-dashboard/master-test-repository.png){ loading=lazy }
...
![Defect Management Dashboard](../../assets/images/engineering-showcase/qa-dashboard/defect-management-dashboard.png){ loading=lazy }
...
![Automation Coverage Dashboard](../../assets/images/engineering-showcase/qa-dashboard/automation-coverage-dashboard.png){ loading=lazy }
